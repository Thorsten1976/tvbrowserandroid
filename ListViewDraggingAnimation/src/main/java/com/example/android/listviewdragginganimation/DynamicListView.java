...
public class DynamicListView extends ListView {
    ...
    private final AdapterView.OnItemLongClickListener mOnItemLongClickListener =
            new AdapterView.OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    mOriginalPos = pointToPosition(mDownX, mDownY);
                    int itemNum = mOriginalPos - getFirstVisiblePosition();
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            hoverViewAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                  ...
                  if(mSortDropListener != null) {
                    mSortDropListener.dropped(mOriginalPos,getPositionForView(getViewForID(mMobileItemId)));
                  }
                  // change end for channel sort
    ...
    public void setSortDropListener(SortDropListener listener) {
      mSortDropListener = listener;
    }
    // change end for channel sort
    /**
